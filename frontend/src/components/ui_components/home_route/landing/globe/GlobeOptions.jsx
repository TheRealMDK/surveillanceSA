...
export const TRAVEL_PATH = [
  { name: "Brasília", lat: -15.7975, lon: -47.8919 },
  // { name: "Abuja", lat: 13.5116, lon: 7.4985 },
  { name: "Mossel Bay", lat: -34.1836, lon: 22.1244 },
];
...
// LIGHTS
export const MAKE_LIGHT_GREEN = false;
export const DIRECTIONAL_LIGHT_INTENSITY = 5;
...
export const TOTAL_GRID_LAT_LINES = 24;
export const TOTAL_GRID_LON_LINES = 48;
export const GRID_LINE_RADIUS = 1.02;
export const GRID_ROTATION_SPEED = 0.0005;
